...
opts1=bodeoptions('cstprefs');opts1.FreqUnits = 'Hz';opts1.XLim={[1 50]};opts1.PhaseWrapping="on";opts1.PhaseWrappingBranch=-360;%opts1.Ylim={[-40 10]};
...
%     i= i - 250
for 
    Q = diag([Q1 , Q2 ,Q3 , Q4 , Qi]); %eps*eye(1,n_states),
    ...
    if stable == 0
        error('Stopping: Unstable closed loop');
    else
