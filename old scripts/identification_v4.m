...
f_vector_CL = logspace( log10(2*freq_resolution*2*pi) , log10(100*2*pi) , 10); %linspace( 2*2*freq_resolution*2*pi , 100*2*pi , 6 );
...
tfest_spa_data11_openloop = tfest(spa_data11_openloop,np_OL,'Ts',Ts,tfest_opt_OL);
% n4sid_spa_data11_openloop = n4sid(spa_data11_openloop,nx,'Ts',Ts,n4sidOpt);
tfest_spa_data11_closedloop = tfest(spa_data11_closedloop,np_CL,'Ts',Ts,tfest_opt_CL)
