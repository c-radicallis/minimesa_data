...
C_estimated_0p = tfest(data_P5_r_to_u , 0 ,'Ts',Ts,tfest_opt_OL)
u_simulated_0p = lsim(C_estimated_0p , erro , time_acq);
figure;hold on;title('Controler:  K=5');title('Controler:  K=5');
plot(time_acq , sv2_acq);
plot(time_acq, u_simulated_0p, 'DisplayName', ['static gain K = ' num2str(C_estimated_0p.Numerator,'%.3f')]);
grid on; legend;
...
C_estimated_0p = tfest(data_P7_r_to_u , 0  ,'Ts',Ts,tfest_opt_OL)
...
C_estimated_0p = tfest(data_P10_r_to_u , 0  ,'Ts',Ts,tfest_opt_OL)
...
C_estimated_0p = tfest(data_P15_r_to_u , 0  ,'Ts',Ts,tfest_opt_OL)
