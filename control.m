...
addpath(func_folder);
Ts = 0.005;
opts1=bodeoptions('cstprefs');opts1.FreqUnits = 'Hz';opts1.XLim={[1 40]};%opts1.Ylim={[-40 10]};
...
Q = diag([zeros(1,n_states),1]);%blkdiag(eye(nx), eye(ny));
R = 1e-20*eye(size(G_open.B,2));
