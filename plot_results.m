...
% Adapted driver response spectra
[picos_ddx_T_acq_2  , picos_x_T_acq_2 ] = ResponseSpectrum( time_vector , x_acq_T_2, ddx_acq_T_2_comp, f_vector , 1);
[picos_ddx_T_acq_4  , picos_x_T_acq_4 ] = ResponseSpectrum( time_vector , x_acq_T_4, ddx_acq_T_4_comp, f_vector , 1);
...
plot(f_vector, picos_x_T_acq_4, '-', 'LineWidth' , 2, 'DisplayName',sprintf( 'Adapted driver 4 - MSE= %.2e', mean((picos_x_tgt_T-picos_x_T_acq_4).^2 )));
